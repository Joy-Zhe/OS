                ...
                if (task[i]) {
                    if (task[i]->pid == arg0) {
                        ...
                        // 4. if find and counter != 0
                            ...
                            current->priority = task[i]->priority + 1; //   4.1. change current process's priority  
                            find_again = 1; //   4.3. goto 1. check again
                            schedule(); //   4.2. call schedule to run other process
                        }
                    }
                }
            }
